package duramater.som;//Grid.java
/**
 ...
 * non-jagged, rectancular observations arrays. Useful
...
public class Grid
{
	...
	/**
	 * Extract the observations for a given row and column
	 * from a Grid object.
	 * 
	 ...
	 * An important property to avoid in a observations
	 ...
	 * of the input observations and units in which they are
